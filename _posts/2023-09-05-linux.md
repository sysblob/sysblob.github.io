...
Everyone has seen the movie where a hacker is typing away on a black screen while code whizzes by. He's gotta hack the FBI mainframe and there's no time! This is our ingrained image of what a computer super genius looks like. The terminal screen. Linux is famous for being a terminal heavy operating system, and one hackers and homelabbers alike love to run. While we may not hack the mainframe, we definitely will get things done faster. Let's take a look at some of the concepts behind Linux.
